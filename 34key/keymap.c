...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo21, OSM(MOD_LSFT)),
    COMBO(combo22, OSM(MOD_LCTL)),
    COMBO(combo23, OSM(MOD_LGUI)),
    COMBO(combo24, OSM(MOD_LALT)),
    COMBO(combo25, OSM(MOD_RSFT)),
    COMBO(combo26, OSM(MOD_RCTL)),
